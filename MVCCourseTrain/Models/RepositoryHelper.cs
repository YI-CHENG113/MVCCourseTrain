namespace MVCCourseTrain.Models
{
	public static class RepositoryHelper
	{
		...
		public static TEST1Repository GetTEST1Repository()
		{
			var repository = new TEST1Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static TEST1Repository GetTEST1Repository(IUnitOfWork unitOfWork)
		{
			var repository = new TEST1Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
